#!/usr/bin/env python3
"""Single doc: Super Boethium De Trinitate"""
...
DOC_KEY = 'Super Boethium De Trinitate'
META = {'nama':'Super Boethium De Trinitate','penulis':'St. Thomas Aquinas','cat':'7a','auth':'reference','kategori':'patristik_skolastik','topic':['patristik','skolastik'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Super Boethium De Trinitate (St. Thomas Aquinas)','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
