#!/usr/bin/env python3
"""
Batch 6j: Tome of Leo, Unitatis_Redintegratio, Veritatis_Splendor, lumen_fidei
"""
...
async def main():
    ...
    logger.info(f'Batch 6j: {len(all_files)} files'); [logger.info(f'  {f.name} ({f.stat().st_size//1024}KB)') for f in all_files]
