#!/usr/bin/env python3
"""
Batch 6f: Mysterium_Fidei, nostra_aetate, Redemptoris_Mater
"""
...
async def main():
    ...
    logger.info(f'Batch 6f: {len(all_files)} files'); [logger.info(f'  {f.name} ({f.stat().st_size//1024}KB)') for f in all_files]
