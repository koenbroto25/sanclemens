#!/usr/bin/env python3
"""Single doc: Evangelii_Gaudium_cleaned"""
...
DOC_KEY = 'Evangelii_Gaudium_cleaned'
META = {'nama':'Evangelii Gaudium','penulis':'Paus Fransiskus','cat':'4','auth':'high','kategori':'dokumen_kepausan','topic':['ensiklik_kepausan','magisterium'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Evangelii Gaudium (Paus Fransiskus)','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
