#!/usr/bin/env python3
"""
Single doc: ALKITAB_Kitab_Suci_Katolik
"""
...
DOC_KEY = 'ALKITAB_Kitab_Suci_Katolik'
META = {'nama':'Alkitab (Kitab Suci Katolik)','penulis':'Para Penulis Kitab Suci','cat':'1','auth':'highest','kategori':'kitab_suci','topic':['kitab_suci','wahyu_ilahi'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Alkitab (Kitab Suci Katolik)','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
