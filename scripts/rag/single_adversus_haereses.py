...
DOC_KEY = 'Adversus_Haereses'
META = {'nama':'Adversus Haereses (Melawan Ajaran-Ajaran Sesat)','penulis':'St. Ireneus dari Lyon','cat':'7a','auth':'reference','kategori':'patristik_skolastik','topic':['patristik','skolastik'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Adversus Haereses (St. Ireneus)','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
