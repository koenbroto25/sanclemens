#!/usr/bin/env python3
"""Single doc: Summa_Theologica _2"""
...
DOC_KEY = 'Summa_Theologica_2'
META = {'nama':'Summa Theologica (Bagian 2)','penulis':'St. Thomas Aquinas','cat':'7a','auth':'reference','kategori':'patristik_skolastik','topic':['patristik','skolastik'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Summa Theologica (Bagian 2, St. Thomas Aquinas)','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
