#!/usr/bin/env python3
"""Single doc: Compendium_of_the_Catechism"""
...
DOC_KEY = 'Compendium_of_the_Catechism'
META = {'nama':'Kompendium Katekismus Gereja Katolik','penulis':'Gereja Katolik','cat':'6','auth':'highest','kategori':'katekismus','topic':['katekismus','kgk'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Kompendium Katekismus Gereja Katolik','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
