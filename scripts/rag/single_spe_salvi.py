...
DOC_KEY = 'spe_salvi'
META = {'nama':'Spe Salvi','penulis':'Paus Benediktus XVI','cat':'4','auth':'high','kategori':'dokumen_kepausan','topic':['ensiklik_kepausan','magisterium'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Spe Salvi (Paus Benediktus XVI)','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
