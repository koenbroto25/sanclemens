...
DOC_KEY = 'Deus_Caritas_Est'
META = {'nama':'Deus Caritas Est','penulis':'Paus Benediktus XVI','cat':'4','auth':'high','kategori':'dokumen_kepausan','topic':['ensiklik_kepausan','magisterium'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Deus Caritas Est (Paus Benediktus XVI)','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
