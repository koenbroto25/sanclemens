#!/usr/bin/env python3
"""Single doc: Summa_Contra_Gentiles"""
...
DOC_KEY = 'Summa_Contra_Gentiles'
META = {'nama':'Summa Contra Gentiles','penulis':'St. Thomas Aquinas','cat':'7a','auth':'reference','kategori':'patristik_skolastik','topic':['patristik','skolastik'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Summa Contra Gentiles (St. Thomas Aquinas)','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
