#!/usr/bin/env python3
"""
Batch 6c: Fides_et_Ratio, Gaudium_et_Spes, Humani_Generis
"""
...
async def main():
    ...
    logger.info(f'Batch 6c: {len(all_files)} files'); [logger.info(f'  {f.name} ({f.stat().st_size//1024}KB)') for f in all_files]
