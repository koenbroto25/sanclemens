#!/usr/bin/env python3
"""
Batch 6g: Sacrosanctum_Concilium, spe_salvi, Summa_Contra_Gentiles
"""
...
async def main():
    ...
    logger.info(f'Batch 6g: {len(all_files)} files'); [logger.info(f'  {f.name} ({f.stat().st_size//1024}KB)') for f in all_files]
