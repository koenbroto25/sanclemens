...
DOC_KEY = 'Dei_Verbum'
META = {'nama':'Dei Verbum','penulis':'Konsili Vatikan II','cat':'3','auth':'highest','kategori':'konsili_ekumenis','topic':['konsili_vatikan_ii','magisterium'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Dei Verbum (Konsili Vatikan II)','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
