#!/usr/bin/env python3
"""Single doc: Sacrosanctum_Concilium"""
...
DOC_KEY = 'Sacrosanctum_Concilium'
META = {'nama':'Sacrosanctum Concilium','penulis':'Konsili Vatikan II','cat':'3','auth':'highest','kategori':'konsili_ekumenis','topic':['konsili_vatikan_ii','magisterium'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Sacrosanctum Concilium (Konsili Vatikan II)','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
