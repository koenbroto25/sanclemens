...
DOC_KEY = 'Fides_et_Ratio'
META = {'nama':'Fides et Ratio','penulis':'Paus Yohanes Paulus II','cat':'4','auth':'high','kategori':'dokumen_kepausan','topic':['ensiklik_kepausan','magisterium'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Fides et Ratio (Paus Yohanes Paulus II)','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
