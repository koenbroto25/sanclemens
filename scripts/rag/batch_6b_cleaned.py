#!/usr/bin/env python3
"""
Batch 6b: Deus_Caritas_Est, Ecclesia_de_Eucharistia, Evangelii_Gaudium_cleaned
"""
...
async def main():
    ...
    logger.info(f'Batch 6b: {len(all_files)} files'); [logger.info(f'  {f.name} ({f.stat().st_size//1024}KB)') for f in all_files]
