#!/usr/bin/env python3
"""
Batch 6i: Summa_Theologica_3-4, Super Boethium De Trinitate
"""
...
DOC_META = {
    ...
    'Summa_Theologica_4': {'nama':'Summa Theologica (Bagian 4)','penulis':'St. Thomas Aquinas','cat':'7a','auth':'reference','kategori':'patristik_skolastik','topic':['patristik','skolastik'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Summa Theologica (Bagian 4, St. Thomas Aquinas)','domain':'theology'},
...
async def main():
    ...
    logger.info(f'Batch 6i: {len(all_files)} files'); [logger.info(f'  {f.name} ({f.stat().st_size//1024}KB)') for f in all_files]
