#!/usr/bin/env python3
"""Single doc: Mulieris_Dignitatem"""
...
DOC_KEY = 'Mulieris_Dignitatem'
META = {'nama':'Mulieris Dignitatem','penulis':'Paus Yohanes Paulus II','cat':'4','auth':'high','kategori':'dokumen_kepausan','topic':['ensiklik_kepausan','magisterium'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Mulieris Dignitatem (Paus Yohanes Paulus II)','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
