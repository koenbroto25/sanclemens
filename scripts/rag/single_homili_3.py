#!/usr/bin/env python3
"""Single doc: Homili_St._Yohanes_Krisostomus_3"""
...
DOC_KEY = 'Homili_St._Yohanes_Krisostomus_3'
META = {'nama':'Homili St. Yohanes Krisostomus (Bagian 3)','penulis':'St. Yohanes Krisostomus','cat':'7a','auth':'reference','kategori':'patristik_skolastik','topic':['patristik','skolastik'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Homili St. Yohanes Krisostomus (Bagian 3)','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
