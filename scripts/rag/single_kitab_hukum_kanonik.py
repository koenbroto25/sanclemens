#!/usr/bin/env python3
"""Single doc: Kitab_Hukum_Kanonik"""
...
DOC_KEY = 'Kitab_Hukum_Kanonik'
META = {'nama':'Kitab Hukum Kanonik (Codex Iuris Canonici)','penulis':'Gereja Katolik','cat':'2','auth':'medium','kategori':'hukum_kanonik','topic':['hukum_kanonik','codex_iuris_canonici'],'bot':['bot_3','bot_8','bot_pastor'],'ref':'Kitab Hukum Kanonik','domain':'theology'}
def chunk_text(text):
    sections = re.split(r'\n(?=#{1,3} |\n)', text); chunks = []
