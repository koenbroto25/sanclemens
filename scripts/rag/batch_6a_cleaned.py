#!/usr/bin/env python3
"""
Batch 6a: 3 documents from cleaned/ — ALKITAB, Compendium, Dei_Verbum
Target: CockroachDB
"""
...
async def main():
    ...
    logger.info(f'Batch 6a: {len(all_files)} files'); [logger.info(f'  {f.name} ({f.stat().st_size//1024}KB)') for f in all_files]
