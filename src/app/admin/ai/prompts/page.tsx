              ...
              <TableBody>
                {prompts.map((prompt) => (
                  <TableRow key={prompt.id}>
                    ...
                    <TableCell>{prompt.is_active ? 'ÁƒÆ’Á†â€™Áƒâ€ ââ‚¬â„¢ÁƒÆ’ââ‚¬Â ÁƒÂ¢ââ€šÂ¬ââ€žÂ¢ÁƒÆ’Á†â€™ÁƒÂ¢ââ€šÂ¬Á…¡ÁƒÆ’ââ‚¬Å¡Áƒâ€šÁ‚Â¢ÁƒÆ’Á†â€™Áƒâ€ ââ‚¬â„¢ÁƒÆ’Á‚Â¢ÁƒÂ¢ââ‚¬Å¡Á‚Â¬Áƒâ€šÁ‚Â¦ÁƒÆ’Á†â€™Áƒâ€šÁ‚Â¢ÁƒÆ’Á‚Â¢ÁƒÂ¢ââ€šÂ¬Á…¡Áƒâ€šÁ‚Â¬ÁƒÆ’ââ‚¬Â¦ÁƒÂ¢ââ€šÂ¬Á…â€œÁƒÆ’Á†â€™Áƒâ€ ââ‚¬â„¢ÁƒÆ’ââ‚¬Å¡Áƒâ€šÁ‚Â¢ÁƒÆ’Á†â€™Áƒâ€šÁ‚Â¢ÁƒÆ’Á‚Â¢ÁƒÂ¢ââ‚¬Å¡Á‚Â¬Áƒâ€¦Á‚¡ÁƒÆ’ââ‚¬Å¡Áƒâ€šÁ‚Â¬ÁƒÆ’Á†â€™ÁƒÂ¢ââ€šÂ¬Á…¡ÁƒÆ’ââ‚¬Å¡Áƒâ€šÁ‚Â¦' : 'ÁƒÆ’Á†â€™Áƒâ€ ââ‚¬â„¢ÁƒÆ’ââ‚¬Â ÁƒÂ¢ââ€šÂ¬ââ€žÂ¢ÁƒÆ’Á†â€™ÁƒÂ¢ââ€šÂ¬Á…¡ÁƒÆ’ââ‚¬Å¡Áƒâ€šÁ‚Â¢ÁƒÆ’Á†â€™Áƒâ€ ââ‚¬â„¢ÁƒÆ’Á‚Â¢ÁƒÂ¢ââ‚¬Å¡Á‚Â¬Áƒâ€¦Á‚¡ÁƒÆ’Á†â€™ÁƒÂ¢ââ€šÂ¬Á…¡ÁƒÆ’ââ‚¬Å¡Áƒâ€šÁ‚ÂÁƒÆ’Á†â€™Áƒâ€ ââ‚¬â„¢ÁƒÆ’Á‚Â¢ÁƒÂ¢ââ‚¬Å¡Á‚Â¬Áƒâ€šÁ‚Â¦ÁƒÆ’Á†â€™Áƒâ€šÁ‚Â¢ÁƒÆ’Á‚Â¢ÁƒÂ¢ââ€šÂ¬Á…¡Áƒâ€šÁ‚Â¬ÁƒÆ’Á‚Â¢ÁƒÂ¢ââ€šÂ¬Á…Â¾Áƒâ€šÁ‚Â¢'}</TableCell>
                    <TableCell>{prompt.is_ab_test ? `ÁƒÆ’Á†â€™Áƒâ€ ââ‚¬â„¢ÁƒÆ’ââ‚¬Â ÁƒÂ¢ââ€šÂ¬ââ€žÂ¢ÁƒÆ’Á†â€™ÁƒÂ¢ââ€šÂ¬Á…¡ÁƒÆ’ââ‚¬Å¡Áƒâ€šÁ‚Â¢ÁƒÆ’Á†â€™Áƒâ€ ââ‚¬â„¢ÁƒÆ’Á‚Â¢ÁƒÂ¢ââ‚¬Å¡Á‚Â¬Áƒâ€šÁ‚Â¦ÁƒÆ’Á†â€™Áƒâ€šÁ‚Â¢ÁƒÆ’Á‚Â¢ÁƒÂ¢ââ€šÂ¬Á…¡Áƒâ€šÁ‚Â¬ÁƒÆ’ââ‚¬Â¦ÁƒÂ¢ââ€šÂ¬Á…â€œÁƒÆ’Á†â€™Áƒâ€ ââ‚¬â„¢ÁƒÆ’ââ‚¬Å¡Áƒâ€šÁ‚Â¢ÁƒÆ’Á†â€™Áƒâ€šÁ‚Â¢ÁƒÆ’Á‚Â¢ÁƒÂ¢ââ‚¬Å¡Á‚Â¬Áƒâ€¦Á‚¡ÁƒÆ’ââ‚¬Å¡Áƒâ€šÁ‚Â¬ÁƒÆ’Á†â€™ÁƒÂ¢ââ€šÂ¬Á…¡ÁƒÆ’ââ‚¬Å¡Áƒâ€šÁ‚Â¦ (${prompt.ab_test_percentage}%)` : 'ÁƒÆ’Á†â€™Áƒâ€ ââ‚¬â„¢ÁƒÆ’ââ‚¬Â ÁƒÂ¢ââ€šÂ¬ââ€žÂ¢ÁƒÆ’Á†â€™ÁƒÂ¢ââ€šÂ¬Á…¡ÁƒÆ’ââ‚¬Å¡Áƒâ€šÁ‚Â¢ÁƒÆ’Á†â€™Áƒâ€ ââ‚¬â„¢ÁƒÆ’Á‚Â¢ÁƒÂ¢ââ‚¬Å¡Á‚Â¬Áƒâ€¦Á‚¡ÁƒÆ’Á†â€™ÁƒÂ¢ââ€šÂ¬Á…¡ÁƒÆ’ââ‚¬Å¡Áƒâ€šÁ‚ÂÁƒÆ’Á†â€™Áƒâ€ ââ‚¬â„¢ÁƒÆ’Á‚Â¢ÁƒÂ¢ââ‚¬Å¡Á‚Â¬Áƒâ€šÁ‚Â¦ÁƒÆ’Á†â€™Áƒâ€šÁ‚Â¢ÁƒÆ’Á‚Â¢ÁƒÂ¢ââ€šÂ¬Á…¡Áƒâ€šÁ‚Â¬ÁƒÆ’Á‚Â¢ÁƒÂ¢ââ€šÂ¬Á…Â¾Áƒâ€šÁ‚Â¢'}</TableCell>
                    <TableCell>
