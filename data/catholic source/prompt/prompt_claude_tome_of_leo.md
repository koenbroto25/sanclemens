# Instruksi Pembersihan dan Pemformatan Dokumen "St. Leo Agung - Tome" untuk AI Knowledge Base

Anda akan diberikan teks mentah (raw text) dari dokumen PDF "Tome of Leo (St. Leo Agung).pdf". Tugas Anda adalah membersihkan teks ini secara presisi dan memformatnya ke dalam format Markdown, dengan menyertakan metadata YAML di bagian atas.

## Metadata Dokumen:
*   **document_code**: `BAPA_SLA_TOME`
*   **title**: "St. Leo Agung - Tome (Surat Dogmatis kepada Flavianus)"
...
2.  **Hapus Header, Footer, dan Nomor Halaman**: Identifikasi dan buang semua teks yang berulang di bagian atas atau bawah halaman, termasuk nomor halaman. Contoh: "24 Seri Dokumen Gerejawi No. 7", "St. Leo Agung - Tome 25".
...
# St. Leo Agung - Tome (Surat Dogmatis kepada Flavianus)

**Kode Dokumen**: `BAPA_SLA_TOME`  
**Kategori**: Bapa Gereja  
**Prioritas**: Pendalaman

> **Deskripsi**: Tome (Surat Dogmatis kepada Flavianus) oleh St. Leo Agung. Dokumen ini telah dibersihkan secara presisi untuk AI Knowledge Base.
