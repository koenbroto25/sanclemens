# Instruksi Pembersihan dan Pemformatan Dokumen "Lumen Fidei" untuk AI Knowledge Base

Anda akan diberikan teks mentah (raw text) dari dokumen PDF "Lumen Fidei". Tugas Anda adalah membersihkan teks ini secara presisi dan memformatnya ke dalam format Markdown, dengan menyertakan metadata YAML di bagian atas.

## Metadata Dokumen:
*   **document_code**: `PAUS_LF`
*   **title**: "Lumen Fidei - Ensiklik tentang Iman"
...
2.  **Hapus Header, Footer, dan Nomor Halaman**: Identifikasi dan buang semua teks yang berulang di bagian atas atau bawah halaman, termasuk nomor halaman. Contoh: "24 Seri Dokumen Gerejawi No. 7", "Lumen Fidei 25".
...
# Lumen Fidei - Ensiklik tentang Iman

**Kode Dokumen**: `PAUS_LF`  
