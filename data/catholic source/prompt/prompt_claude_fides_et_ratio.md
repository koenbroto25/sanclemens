# Instruksi Pembersihan dan Pemformatan Dokumen "Fides et Ratio" untuk AI Knowledge Base

Anda akan diberikan teks mentah (raw text) dari dokumen PDF "Fides et Ratio". Tugas Anda adalah membersihkan teks ini secara presisi dan memformatnya ke dalam format Markdown, dengan menyertakan metadata YAML di bagian atas.

## Metadata Dokumen:
*   **document_code**: `PAUS_FR`
*   **title**: "Fides et Ratio - Ensiklik tentang Iman dan Akal Budi"
...
2.  **Hapus Header, Footer, dan Nomor Halaman**: Identifikasi dan buang semua teks yang berulang di bagian atas atau bawah halaman, termasuk nomor halaman. Contoh: "24 Seri Dokumen Gerejawi No. 7", "Fides et Ratio 25".
...
# Fides et Ratio - Ensiklik tentang Iman dan Akal Budi

**Kode Dokumen**: `PAUS_FR`  
**Kategori**: Ensiklik Paus  
**Prioritas**: Pendalaman

> **Deskripsi**: Ensiklik tentang Iman dan Akal Budi. Dokumen ini telah dibersihkan secara presisi untuk AI Knowledge Base.
