# Instruksi Pembersihan dan Pemformatan Dokumen "Unitatis Redintegratio" untuk AI Knowledge Base

Anda akan diberikan teks mentah (raw text) dari dokumen PDF "Unitatis Redintegratio". Tugas Anda adalah membersihkan teks ini secara presisi dan memformatnya ke dalam format Markdown, dengan menyertakan metadata YAML di bagian atas.

## Metadata Dokumen:
*   **document_code**: `VATII_UR`
*   **title**: "Unitatis Redintegratio - Dekrit tentang Ekumenisme"
...
2.  **Hapus Header, Footer, dan Nomor Halaman**: Identifikasi dan buang semua teks yang berulang di bagian atas atau bawah halaman, termasuk nomor halaman. Contoh: "24 Seri Dokumen Gerejawi No. 7", "Unitatis Redintegratio 25".
...
**Kode Dokumen**: `VATII_UR`  
**Kategori**: Konsili Vatikan II  
**Prioritas**: WAJIB

> **Deskripsi**: Dekrit tentang Ekumenisme dari Konsili Vatikan II. Dokumen ini telah dibersihkan secara presisi untuk AI Knowledge Base.
