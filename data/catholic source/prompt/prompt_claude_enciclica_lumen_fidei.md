# Instruksi Pembersihan dan Pemformatan Dokumen "Enciclica Lumen Fidei" untuk AI Knowledge Base

Anda akan diberikan teks mentah (raw text) dari dokumen PDF "enciclica-lumen-fidei.pdf". Tugas Anda adalah membersihkan teks ini secara presisi dan memformatnya ke dalam format Markdown, dengan menyertakan metadata YAML di bagian atas.

## Metadata Dokumen:
*   **document_code**: `PAUS_LF2`
*   **title**: "Enciclica Lumen Fidei - Ensiklik tentang Iman"
...
2.  **Hapus Header, Footer, dan Nomor Halaman**: Identifikasi dan buang semua teks yang berulang di bagian atas atau bawah halaman, termasuk nomor halaman. Contoh: "24 Seri Dokumen Gerejawi No. 7", "Enciclica Lumen Fidei 25".
...
# Enciclica Lumen Fidei - Ensiklik tentang Iman

**Kode Dokumen**: `PAUS_LF2`  
**Kategori**: Ensiklik Paus  
**Prioritas**: Pendalaman

> **Deskripsi**: Ensiklik tentang Iman. Dokumen ini telah dibersihkan secara presisi untuk AI Knowledge Base.
