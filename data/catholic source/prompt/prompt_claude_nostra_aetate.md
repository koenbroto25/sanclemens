# Instruksi Pembersihan dan Pemformatan Dokumen "Nostra Aetate" untuk AI Knowledge Base

Anda akan diberikan teks mentah (raw text) dari dokumen PDF "Nostra Aetate". Tugas Anda adalah membersihkan teks ini secara presisi dan memformatnya ke dalam format Markdown, dengan menyertakan metadata YAML di bagian atas.

## Metadata Dokumen:
*   **document_code**: `VATII_NA`
*   **title**: "Nostra Aetate - Pernyataan tentang Hubungan Gereja dengan Agama-agama Bukan Kristen"
*   **category**: "Konsili Vatikan II"
*   **priority**: "WAJIB"
...
2.  **Hapus Header, Footer, dan Nomor Halaman**: Identifikasi dan buang semua teks yang berulang di bagian atas atau bawah halaman, termasuk nomor halaman. Contoh: "24 Seri Dokumen Gerejawi No. 7", "Nostra Aetate 25".
...
**Kode Dokumen**: `VATII_NA`  
**Kategori**: Konsili Vatikan II  
**Prioritas**: WAJIB

> **Deskripsi**: Pernyataan tentang Hubungan Gereja dengan Agama-agama Bukan Kristen dari Konsili Vatikan II. Dokumen ini telah dibersihkan secara presisi untuk AI Knowledge Base.
