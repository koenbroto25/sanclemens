# Instruksi Pembersihan dan Pemformatan Dokumen "Ecclesia de Eucharistia" untuk AI Knowledge Base

Anda akan diberikan teks mentah (raw text) dari dokumen PDF "Ecclesia de Eucharistia". Tugas Anda adalah membersihkan teks ini secara presisi dan memformatnya ke dalam format Markdown, dengan menyertakan metadata YAML di bagian atas.
...
2.  **Hapus Header, Footer, dan Nomor Halaman**: Identifikasi dan buang semua teks yang berulang di bagian atas atau bawah halaman, termasuk nomor halaman. Contoh: "24 Seri Dokumen Gerejawi No. 7", "Ecclesia de Eucharistia 25".
...
> **Deskripsi**: Ensiklik tentang Ekaristi dalam Hidup Gereja. Dokumen ini telah dibersihkan secara presisi untuk AI Knowledge Base.
