# Instruksi Pembersihan dan Pemformatan Dokumen "Veritatis Splendor" untuk AI Knowledge Base

Anda akan diberikan teks mentah (raw text) dari dokumen PDF "Veritatis Splendor". Tugas Anda adalah membersihkan teks ini secara presisi dan memformatnya ke dalam format Markdown, dengan menyertakan metadata YAML di bagian atas.
...
2.  **Hapus Header, Footer, dan Nomor Halaman**: Identifikasi dan buang semua teks yang berulang di bagian atas atau bawah halaman, termasuk nomor halaman. Contoh: "24 Seri Dokumen Gerejawi No. 7", "Veritatis Splendor 25".
...
> **Deskripsi**: Ensiklik tentang Kebenaran Moral. Dokumen ini telah dibersihkan secara presisi untuk AI Knowledge Base.
