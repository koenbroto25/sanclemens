# Instruksi Pembersihan dan Pemformatan Dokumen "Mulieris Dignitatem" untuk AI Knowledge Base

Anda akan diberikan teks mentah (raw text) dari dokumen PDF "Mulieris Dignitatem". Tugas Anda adalah membersihkan teks ini secara presisi dan memformatnya ke dalam format Markdown, dengan menyertakan metadata YAML di bagian atas.

## Metadata Dokumen:
*   **document_code**: `PAUS_MD`
*   **title**: "Mulieris Dignitatem - Surat Apostolik tentang Martabat dan Panggilan Wanita"
...
2.  **Hapus Header, Footer, dan Nomor Halaman**: Identifikasi dan buang semua teks yang berulang di bagian atas atau bawah halaman, termasuk nomor halaman. Contoh: "24 Seri Dokumen Gerejawi No. 7", "Mulieris Dignitatem 25".
...
# Mulieris Dignitatem - Surat Apostolik tentang Martabat dan Panggilan Wanita

**Kode Dokumen**: `PAUS_MD`  
**Kategori**: Ensiklik Paus  
**Prioritas**: Pendalaman

> **Deskripsi**: Surat Apostolik tentang Martabat dan Panggilan Wanita. Dokumen ini telah dibersihkan secara presisi untuk AI Knowledge Base.
