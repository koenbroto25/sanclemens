# Instruksi Pembersihan dan Pemformatan Dokumen "Spe Salvi" untuk AI Knowledge Base

Anda akan diberikan teks mentah (raw text) dari dokumen PDF "Spe Salvi". Tugas Anda adalah membersihkan teks ini secara presisi dan memformatnya ke dalam format Markdown, dengan menyertakan metadata YAML di bagian atas.
...
2.  **Hapus Header, Footer, dan Nomor Halaman**: Identifikasi dan buang semua teks yang berulang di bagian atas atau bawah halaman, termasuk nomor halaman. Contoh: "24 Seri Dokumen Gerejawi No. 7", "Spe Salvi 25".
