# Instruksi Pembersihan dan Pemformatan Dokumen "Humani Generis" untuk AI Knowledge Base

Anda akan diberikan teks mentah (raw text) dari dokumen PDF "Humani-Generis-August-12-1950-PIUS-XII.pdf". Tugas Anda adalah membersihkan teks ini secara presisi dan memformatnya ke dalam format Markdown, dengan menyertakan metadata YAML di bagian atas.
...
2.  **Hapus Header, Footer, dan Nomor Halaman**: Identifikasi dan buang semua teks yang berulang di bagian atas atau bawah halaman, termasuk nomor halaman. Contoh: "24 Seri Dokumen Gerejawi No. 7", "Humani Generis 25".
